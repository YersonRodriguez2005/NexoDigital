...
const WhatsAppButton = () => {
  ...
  // MENTOR TIP: Estado para mostrar el tooltip temporalmente en móviles
  ...
  // MENTOR TIP: Saluda al usuario automáticamente a los 2.5s y se oculta a los 7s
  useEffect(() => {
    const showTimer = setTimeout(() => setAutoTooltip(true), 2500);
    const hideTimer = setTimeout(() => setAutoTooltip(false), 7000);
    return () => {
  ...
  // Determina si mostrar el tooltip (por hover manual o por el saludo automático)
  const isTooltipVisible = hovered || autoTooltip;
    ...
    <>
      <style>{`
        ...
        .wa-wrapper {
          ...
          bottom: 28px;
          right: 28px;
          z-index: 50; /* MENTOR TIP: Jerarquía clara (Debajo del Navbar que es 9999) */
          display: flex;
        ...
        .wa-tooltip-name {
          ...
          color: #fff;
          line-height: 1.2;
          margin: 0; /* Aseguramos que no haya márgenes no deseados */
        }
        ...
        {isTooltipVisible && (
          <div className="wa-tooltip">
            ...
            <div className="wa-tooltip-content">
              ...
              <p className="wa-tooltip-msg">¡Hola! Escríbeme para comprar tu software</p>
            </div>
          </div>
        )}
