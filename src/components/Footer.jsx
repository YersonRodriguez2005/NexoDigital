...
const TECH_TAGS = ['React', 'Node.js', 'PostgreSQL', 'Capacitor', 'Vite', 'TailwindCSS'];
  ...
  return (
    <>
      <style>{`
        ...
        .ft-footer {
          position: relative; background: #070E1E; overflow: hidden;
        }
        ...
        /* Ambient glow */
        .ft-glow {
          position: absolute; width: 500px; height: 300px; top: -100px; left: 50%; transform: translateX(-50%);
          background: radial-gradient(ellipse, rgba(37,99,235,0.08) 0%, transparent 70%);
          pointer-events: none; animation: ftGlow 5s ease-in-out infinite;
        }
        ...
        .ft-inner {
          position: relative; z-index: 2; max-width: 1280px; margin: 0 auto; padding: 80px 2rem 0;
        }

        /* ── Grid ── */
        .ft-grid {
          display: grid; grid-template-columns: 2.2fr 1fr 1.2fr; gap: 4rem; padding-bottom: 56px;
        }
        ...
        .ft-logo-text span { color: #2563EB; }
        .ft-brand-desc {
          font-family: 'Inter', sans-serif; font-size: 0.875rem; line-height: 1.75;
          color: #475569; max-width: 380px;
        }

        /* Tech tags */
        .ft-tech-tags { display: flex; flex-wrap: wrap; gap: 6px; }
        .ft-tech-tag {
          display: inline-flex; padding: 3px 8px; border-radius: 6px;
          background: rgba(37,99,235,0.08); border: 1px solid rgba(37,99,235,0.15);
          font-family: 'Montserrat', sans-serif; font-size: 0.625rem; font-weight: 700;
          color: #475569; letter-spacing: 0.06em; text-transform: uppercase;
        }
        ...
        .ft-status {
          ...
          border-radius: 100px; width: fit-content; margin-top: 4px;
        }
        .ft-status-dot {
        ...
        /* ── Column 2: Nav ── */
        .ft-nav-col { animation: ${inView ? 'ftFadeUp 0.6s 200ms both' : 'none'}; }
        .ft-col-title {
          font-family: 'Montserrat', sans-serif; font-size: 0.6875rem; font-weight: 700;
          color: #fff; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 1.25rem;
          display: flex; align-items: center; gap: 8px;
        }
        .ft-col-title::after {
          content: ''; flex: 1; height: 1px; background: rgba(255,255,255,0.06);
          transform-origin: left; animation: ${inView ? 'ftLineGrow 0.5s 0.3s both' : 'none'};
        }
        .ft-nav-list {
        ...
        .ft-nav-link {
          ...
          font-size: 0.875rem; color: #475569; text-decoration: none; padding: 6px 0;
          border-left: 2px solid transparent; transition: color 0.2s, border-color 0.2s, padding-left 0.2s;
        }
        .ft-nav-link:hover { color: #fff; border-left-color: #2563EB; padding-left: 10px; }

        /* ── Column 3: Contact & SEO ── */
        .ft-social-col { animation: ${inView ? 'ftFadeUp 0.6s 300ms both' : 'none'}; }
        .ft-social-row { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 1.5rem; }
        
        /* Contenedor Semántico para SEO Local */
        .ft-contact-info {
          display: flex; flex-direction: column; gap: 10px; font-style: normal;
        }
        .ft-info-item {
          display: flex; align-items: center; gap: 8px; font-family: 'Inter', sans-serif;
          font-size: 0.8125rem; color: #475569;
        }
        .ft-info-item svg { color: #475569; flex-shrink: 0; }
        .ft-info-item a { color: #475569; text-decoration: none; transition: color 0.2s; }
        .ft-info-item a:hover { color: #fff; }

        /* ── Bottom bar ── */
        .ft-bottom {
          border-top: 1px solid rgba(255,255,255,0.05); padding: 1.5rem 0 2rem;
          display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap;
          animation: ${inView ? 'ftFadeUp 0.6s 400ms both' : 'none'};
        }
        .ft-copyright { font-family: 'Inter', sans-serif; font-size: 0.75rem; color: #334155; }
        .ft-copyright strong { color: #475569; }
        .ft-credits {
          display: flex; align-items: center; gap: 8px; font-family: 'Inter', sans-serif;
          font-size: 0.75rem; color: #334155;
        }
        .ft-credits-heart { color: #f87171; font-size: 0.875rem; }
        .ft-credits a { color: #2563EB; text-decoration: none; font-weight: 600; transition: color 0.2s; }
        .ft-credits a:hover { color: #60a5fa; }
        ...
        <div className="ft-inner">
          ...
          <div className="ft-grid">
            ...
            <div className="ft-brand">
              ...
              {/* MENTOR TIP: Descripción optimizada con palabras clave semánticas */}
              <p className="ft-brand-desc">
                Agencia de desarrollo de software en Neiva, Huila. Creamos plataformas web, sistemas de gestión POS y aplicaciones móviles a la medida para modernizar empresas en toda Colombia.
              </p>
            ...
            <div className="ft-social-col">
              ...
              {/* MENTOR TIP: Etiqueta <address> con Integridad N-A-P para Google Maps */}
              <address className="ft-contact-info">
                <div className="ft-info-item">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path d="M7 1C4.79 1 3 2.79 3 5C3 8 7 13 7 13C7 13 11 8 11 5C11 2.79 9.21 1 7 1Z" stroke="currentColor" strokeWidth="1.25"/>
                ...
                <div className="ft-info-item">
                  <PhoneIcon />
                  <a href="tel:+573216393715" title="Llamar a Nexo Digital">+57 321 639 3715</a>
                </div>
